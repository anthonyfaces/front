...
@Component({
  selector: 'app-especialidad-edcion',
  templateUrl: './especialidad-edcion.component.html',
  styleUrls: ['./especialidad-edcion.component.css']
})
export class EspecialidadEdcionComponent implements OnInit {
